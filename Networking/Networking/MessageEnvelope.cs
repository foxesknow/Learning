...
namespace Networking
{
	...
	{
		private const int BeginMagicNumber=0x4f4c4548;  // HELO
		private const int EndMagicNumber=0x6f6c6568;    // helo
		...
		/// <summary>
		/// The correlation ID of the message within the system ID
		/// </summary>
